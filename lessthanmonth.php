...
$rows = mysql_num_rows($lessthanmonth);
if($rows >0)
{
?>
...
<table width="100%" border="1" cellspacing="0" cellpadding="0" style="font-family:'Trebuchet MS'; font-size:13px;">
  <tr style="background-color:#e2fcdb;">
    ...
    <th align="center" valign="middle"  ><div style="word-wrap:break-word; width:130px;">Sender name & address</div></th>
    ...
    <th align="center" valign="middle"  ><div style="word-wrap:break-word; width:100px;">Actiontaken</div></th>
    <th align="center" valign="middle"  ><div style="word-wrap:break-word; width:100px;">Status</div></th>
...
while($result = mysql_fetch_array($lessthanmonth))
{ 
 ?>
 ...
 <div>
  <tr  >
    ...
    <td align="center" valign="middle" ><div style="word-wrap:break-word; width:130px;"><?php echo " Name : ".ucfirst($result['sendername']); echo  '<br>'; echo "Address : ".$result['senderaddress']; ?></div></td>
    ...
    <td align="center" valign="middle" ><div style="word-wrap:break-word; width:100px;"><?php echo ucfirst($result['actiontaken']);?></div></td>
    <td align="center" valign="middle" ><div style="word-wrap:break-word; width:100px;"><?php echo ucfirst($result['status']);?></div></td>
