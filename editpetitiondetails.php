...
$user = new User();
$id = $_GET['id'];
$sqlselect = mysql_query("SELECT * FROM petition WHERE petitionid = '".$id."' ");
$arrayresult = mysql_fetch_assoc($sqlselect);
$referencenumber  = $arrayresult['referencenumber'];
...
foreach($_FILES['file']['tmp_name'] as $key => $tmp_name )
		{
			...
			{
				$file[] = $arrayresult['file'];
			}
		}
		$file =  implode(',',$file);

	
		$petitionupdate = $user->petitionupdate($id,mysql_real_escape_string($_POST['name']),$_POST['gender'],mysql_real_escape_string($_POST['fhname']),mysql_real_escape_string($_POST['hno']),mysql_real_escape_string($_POST['street']),$_POST['mandal'],$_POST['village'],mysql_real_escape_string($_POST['mobile']),$_POST['subjectrequest'],mysql_real_escape_string($_POST['content']),$file,$_POST['forwarded'],mysql_real_escape_string($_POST['remarks']));
	
	if ($petitionupdate)
	{
	// Success
		header("location:searchpetitionresult.php?msg=msg");
		exit;
	} else
	{
	//  Failed
  ...
  <form method="post" enctype="multipart/form-data">
    <div class="form">
      ...
      <div class="text_feiled_">
        <input class="feoiled_box" name="name" type="text" id="name" value="<?php echo $arrayresult['name']; ?>" />
      </div>
    </div>
    <div class="form">
      <div class="text_form">Gender</div>
      <div class="text_feiled_" style="padding-top:5px;">
        <input name="gender" type="radio" value="male" <?php if($arrayresult['gender'] == 'male') { ?> checked <?php } ?>/>
        Male
        <input name="gender" type="radio" value="female" <?php if($arrayresult['gender'] == 'female') { ?> checked <?php } ?> />
        Female</div>
    </div>
    <div class="form">
      <div class="text_form">Father/Husband Name:</div>
      <div class="text_feiled_">
        <input class="feoiled_box" name="fhname" type="text" value="<?php echo $arrayresult['fhname']; ?>"  />
      </div>
    </div>
    <div class="form">
    ...
    <div class="form">
      ...
      <div class="text_feiled_">
        <input class="feoiled_box" name="hno" type="text" id="hno" value="<?php echo $arrayresult['hno']; ?>" />
      </div>
    </div>
    <div class="form">
      <div class="text_form">Street</div>
      <div class="text_feiled_" >
        <input class="feoiled_box" name="street" type="text" id="street" value="<?php echo $arrayresult['street']; ?>" />
      </div>
    </div>
    <div class="form">
      ...
      <div class="text_feiled_">
		...
		if($mandal['type'] == 'town')
		  ...
		  ?>
          <option value="<?php echo $mandal['mandalid'];?>" <?php if($arrayresult['mandal']== $mandal['mandalid']){ ?> selected<?php } ?>><?php echo $mandal['mandalname'].' '.$type; ?></option>
          <?php
		}?>
        </select>
      </div>
    ...
    <div class="form">
      ...
      <div class="text_feiled_">
<?php  $result = mysql_query("SELECT * FROM villagemaster WHERE mandalid = '".$arrayresult['mandal']."'");
?>
        <select class="dropdown" name="village" id="village">
<?php while($arrayvillage = mysql_fetch_assoc($result))
		  {
		  ?>
          <option value="<?php echo $arrayvillage['villageid'];?>" <?php if($arrayresult['village'] == $arrayvillage['villageid']){ ?> selected<?php } ?>><?php echo $arrayvillage['villagename'].' '.$type; ?></option>
          <?php
		}?>
        </select>
      </div>
    ...
    <div class="form">
      ...
      <div class="text_feiled_">
        <input class="feoiled_box" name="mobile" type="text" id="mobile" maxlength="10" value="<?php echo $arrayresult['mobile']; ?>" />
      </div>
    </div>
    <div class="form">
      ...
      <div class="text_feiled_">
        <select class="dropdown" name="subjectrequest" id="subjectrequest">
		  ...
		  {
		  ?>
          <option value="<?php echo $petition['petitionid'];?>"  <?php if($arrayresult['subjectrequest'] == $petition['petitionid']){ ?> selected<?php } ?>><?php echo $petition['petitionname']; ?></option>
          <?php
		}?>
        </select>
      </div>
    ...
    <div class="form_add">
      ...
      <div class="text_feiled_">
        <textarea  name="content" type="text" cols="40" rows="4" id="content"><?php echo $arrayresult['content']; ?></textarea>
      </div>
    </div>
    <div class="form">
    ...
    <div class="form">
      ...
      <div class="text_feiled_">
        <select class="dropdown" name="forwarded" id="forwarded">
		  ...
		  {
		  ?>
          <option value="<?php echo $petitionforward['petitionforwardid'];?>" <?php if($arrayresult['forwarded'] == $petitionforward['petitionforwardid']){ ?> selected<?php } ?>><?php echo $petitionforward['petitionforwardname']; ?></option>
          <?php
		}?>
        </select>
      </div>
    ...
    <div class="form_add">
      ...
      <div class="text_feiled_">
        <textarea  name="remarks" type="text" cols="40" rows="4" id="remarks"><?php echo $arrayresult['remarks']; ?></textarea>
      </div>
    </div>
    <div>
